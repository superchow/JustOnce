...
<head>
    ...
    /*导航栏*/
		...
		/*页脚*/
		#footer{background-color: #3d444c;width:100%;font-size:16px;position: absolute;bottom: 0px;}
...
<nav>
	...
	<table border=0 height=600px align=left>
		<tr>
			<!-- 存放树菜单 -->
			<td width=260px align=left valign=top style="border-right: #999999 1px dashed"><ul id="treeDemo" class="ztree" style="width:260px; overflow:auto; position: absolute; top: 55px;left: 100px;"></ul></td>
			<!-- 放对应显示的内容 -->
			<td width=770px align=left valign=top style="position: absolute; top: 55px;"><iframe ID="testIframe" Name="testIframe" frameborder="" =0 scrolling="" =auto width=100%  height=600px src="" frameborder="0"></iframe></td>
		</tr>
	</table>
